...
class TestStageExtractIntegration:
    ...
    async def test_stage_extract_full_pipeline(self, tmp_path, sample_ingest_result):
        ...
        assert "Diversified" in all_text or "Risk management" in all_text  # At least one bullet content
...
class TestDeterministicPDF:
    ...
    def create_deterministic_pdf(self, path: Path) -> None:
        ...
        page1.insert_text((50, 130), "Our analysis suggests a cautiously optimistic approach to equity markets in Q4 2024.", fontsize=11)
