    ...
    async def test_stage_index_with_query(self):
        ...
        blocks = [
            ...
            DocumentBlock(
                ...
                page=1,
                text="We are overweight on technology stocks due to strong earnings growth and AI tailwinds. "
                * 10,
                block_type=BlockType.PARAGRAPH,
                bbox=None,
                confidence=1.0,
    ...
    async def test_query_relevance(self):
        ...
        blocks = [
            ...
            DocumentBlock(
                block_id="doc_rel_1",
                page=1,
                text="We are bullish on technology stocks due to AI innovation and strong cloud adoption. "
                * 10,
                block_type=BlockType.PARAGRAPH,
                bbox=None,
                confidence=1.0,
        ...
        with patch("src.retrieval.indexer.generate_embeddings") as mock_generate:
            ...
            with patch("src.retrieval.indexer.OpenAIEmbeddingProvider") as mock_provider_class:
                ...
                with patch("src.retrieval.indexer.get_settings"):
                    ...
                    assert (
                        "technology" in results[0].text.lower() or "tech" in results[0].text.lower()
                    )
